...
# Reading in the data
data_global <- read.csv("2-Cleaned_data/Parcel_cleaned_df.csv") 
...
resids_sp <- spchisq_results$stdres


# Cramer's V to evaluate effect size 
cramers_v <- cramerV(spchsq_contingency_table)
print(cramers_v)
#=========================================================#
                # CONTRIBUTION TABLE #
#=========================================================#
...
resids_heatmap_sp <- pheatmap(resids_sp,
         display_numbers = TRUE,
         number_color = "black",
         fontsize_number = 15,
         cluster_rows = FALSE,
...
ggsave(resids_heatmap_sp, 
       filename = "Q2.3_resids_heatmap_sp_plot.png",
