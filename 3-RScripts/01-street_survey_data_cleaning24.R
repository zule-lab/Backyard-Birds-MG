...
street_surveys$Plant.species[which(street_surveys$Plant.species== "Northern acclaim honeylocust ")] <- "Honey locust"
...
#names(street_surveys)[names(street_surveys) == 'Streetode'] <- 'Yard.code'
...
write.csv(street_surveys, "2-Cleaned_data/street_surveys_cleaned24.csv", row.names=FALSE)
