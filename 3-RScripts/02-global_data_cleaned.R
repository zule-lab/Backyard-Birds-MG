...
yards <- read.csv("2-Cleaned_data/yard_surveys_cleaned.csv")
streets <- read.csv("2-Cleaned_data/street_surveys_cleaned.csv")
...
write.csv(byb, "2-Cleaned_data/backyard_birds.csv")
